...
kable(top_hospitals_df, 
      ...
      caption = "Table 6. Top Performing Hospitals by Category (percentage of of total procurment from diverse suppleirs)")
...
# Create a viridis color palette for Total Minority
...
It is also important to note that many indivudals submitting these reports on the behalf of hospitals may not choose to submit a diversity statment, thus many entries invovled smaller nonsensicle terms like "N/A". 
...
final_hospitals %>%
  ...
  geom_col()+
  title("Top 20 Tokens Found In Supplier Diversity Statements")
```
...
kable(tf_idf_grouped, caption = " Table 10. TF-IDF values for the Top 5 Words in Supplier Diversity Statements Hospital Type ")

```

## Supplier Diversity Statments 

If you want to see the supplier diversity statemetn for a specific hopsital of your choosing you can enter in the search bar below! 
